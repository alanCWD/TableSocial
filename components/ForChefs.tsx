    ...
    <div className="bg-[#faf9f6]">
      ...
      <section className="bg-culinary text-white py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-accent font-bold uppercase tracking-[0.4em] text-xs mb-6">The Artisan Portal</h2>
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8">Elevate Your Table.</h1>
          <p className="text-gray-300 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed">
            The destination for Victoria's elite chefs to list events, verify identities, and connect with a community of intentional diners.
          </p>
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            ...
            <button className="border-2 border-white text-white font-bold px-10 py-4 rounded-2xl hover:bg-white hover:text-culinary transition-all uppercase tracking-widest text-xs">Create Pop-up Event</button>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="aspect-video bg-[#faf9f6] rounded-[3rem] p-12 border border-gray-100 shadow-inner flex flex-col justify-center">
              <div className="flex gap-4 mb-8">
                <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-gray-100" />
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white rounded-xl border border-gray-100 text-gray-400 text-xs italic">
                  Link your Instagram, Website, and Menu to "fill in the blanks" of your discovery profile.
                </div>
              </div>
            </div>
            <div>
              <h3 className="text-accent font-bold uppercase tracking-[0.3em] text-xs mb-4">Complete Your Story</h3>
              <h2 className="text-4xl font-serif font-bold text-culinary mb-8">Fill in the Blanks.</h2>
              <p className="text-gray-500 font-light leading-relaxed mb-8">
                While our system automatically aggregates events from Google and social media, creating an official profile allows you to curate your image, link directly to your ticketing platforms, and build a lasting legacy.
              </p>
              <ul className="space-y-4 mb-10">
                {['Custom Portfolio Gallery', 'Direct Ticketing Integration', 'Community Message Board', 'Event Analytics'].map(f => (
