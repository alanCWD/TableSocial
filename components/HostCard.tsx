...
export const HostCard: React.FC<HostCardProps> = ({ host, onClick }) => {
  return (
    ...
    >
      <div className="relative w-32 h-32 mb-4 rounded-full overflow-hidden shadow-md group-hover:shadow-xl transition-all duration-300 border-4 border-white">
        <img 
          src={host.imageUrl} 
          alt={host.name} 
        ...
        {host.verified && (
          <div className="absolute bottom-0 right-0 bg-accent text-white p-1 rounded-full shadow-lg border-2 border-white">
      ...
      <h4 className="font-serif text-lg font-bold text-culinary mb-1 group-hover:text-accent transition-colors">
        {host.name}
      </h4>
