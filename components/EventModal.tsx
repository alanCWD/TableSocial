          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 h-64 md:h-auto relative">
              ...
              <div className="absolute bottom-6 left-6 text-white pr-6">
                <p className="text-accent font-bold uppercase tracking-widest text-[10px] mb-1">{event.category}</p>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  >
                    ...
                    <p className="text-sm font-bold text-culinary line-clamp-1">{event.venue?.name}</p>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <p className="text-sm font-bold text-culinary">{event.date} at {event.time}</p>
                  </div>
                </div>
